...
export const API_URL = 'http://146.185.158.18/fake_api.php';
export const POLLING_INTERVAL_MS = 10000;
export const STORAGE_ID_WATCH_LATER = 'watch_later_items';
export const POLLING_STOPPED_MESSAGE = 'There was an error in the request, ' +
                                        'polling is stopped. Refresh the page.';
